...
<input name="_method" type="hidden" value="PATCH">
          ...
          <div class="form-group">      
              <label for="first_name">Designation</label><br/> 
              <input type="text" class="form-control" name="designation" value={{$teacher->designation}}>  
          </div>  
          
          <div class="form-group">      
              <label for="first_name">Speciality</label><br/> 
              <input type="text" class="form-control" name="speciality" value={{$teacher->speciality}}>
          </div>  
