...
<h3 style="text-align:center">User Profile</h3>
  <img src="uploads/teacher.png"  alt="#" style="width:60%; margin: auto;  border-radius: 50%;" >
  <h4>{{$user->name}}</h4>
  ...
  <h5>Id: {{$user->id}}</h5>
  <h5>Number: {{$teachers->number}}</h5>
  <h5>Designation: {{$teachers->designation}}</h5>
  <h5>Speciality: {{$teachers->speciality}}</h5>
