      ...
      <form method="post" action="{{url('admins')}}">
          <h3 style="text-align:center">Enter Admin Details</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input name="adminid" type="text" class="form-control"  placeholder="Enter unique Admin ID">
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input name="Address" type="text" class="form-control"  placeholder="Enter Address"></br>
                        </div>
